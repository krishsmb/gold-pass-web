...
@Component({
  selector: 'app-event-i-host',
  templateUrl: './event-i-host.component.html',
  styleUrls: ['./event-i-host.component.css']
})
export class EventIHostComponent implements OnInit {
